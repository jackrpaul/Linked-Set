...
/** Tests whether this set contains a given entry.
    ...
    @return  True if the set contains anEntry, or false if 
not. */
public boolean contains(T anEntry);

/** Reverse all entries that are in this set
For example: Input : Head of following linked list 
C->A->D->B->NULL
Output : Linked list should be changed to 
B->D->A->C->NULL
@param head:  the first node of the linked set to reverse
@return The reversed linked set if the reverse was 
successful, or null */
